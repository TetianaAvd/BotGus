...
public class Main extends TelegramLongPollingBot {
    //BanderoGusTanya_bot
    //6191457837:AAFFvvmwhFnjJin47Lz7tYASi_kKALbN0Yo
    ...
    public String getBotUsername() {
        return "BanderoGusTanya_bot";
    }

    @Override
    public String getBotToken() {
        return "6191457837:AAFFvvmwhFnjJin47Lz7tYASi_kKALbN0Yo";
    }

    @Override
    public void onUpdateReceived(Update update) {
        Long chatId = getCatId(update);
    ...
    public Long getCatId(Update update){
